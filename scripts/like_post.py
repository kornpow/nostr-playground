...
async def create_like_event(keys: Keys, target_event: any, content: str = "+", relay_urls: list = None):
    """
    ...
    try:
        event_builder = EventBuilder.reaction(
            target_event,
            content
        )
...
async def main():
    ...
    parser.add_argument('--unlike', action='store_true', help='Unlike the post (send empty reaction)')
